register_namespace('util.string');

util.string.levenshtein = function (s1, s2) {
...
util.string.utf8_encode = function(argString) {
    // http://kevin.vanzonneveld.net
...
util.string.nl2br = function(str, is_xhtml) {
...
util.string.strip_tags = function(input, allowed) {
    // http://kevin.vanzonneveld.net
    // +   original by: Kevin van Zonneveld (http://kevin.vanzonneveld.net)
