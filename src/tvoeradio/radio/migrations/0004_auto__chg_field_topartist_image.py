...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TopArtist.image'
        db.alter_column('radio_topartist', 'image', self.gf('django.db.models.fields.URLField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'TopArtist.image'
        db.alter_column('radio_topartist', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
